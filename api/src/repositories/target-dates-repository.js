...
module.exports = {
  getAllTargetDates: async () => {
    ...
    try {
      ...
      throw new Error(`Failed to get target dates from Cosmos DB after retries: ${error.message}`);
    }
  },
  ...
  deleteTargetDate: async (id) => {
    ...
    try {
      ...
      throw new Error(`Failed to delete target date from Cosmos DB after retries: ${error.message}`);
    }
  },
